/********************************** (C) COPYRIGHT *******************************
* File Name          : ch32非0x_usbotg_host.h
* Author             : WCH
* Version            : V1.0.0
* Date               : 2021/06/06
...
*******************************************************************************/
#ifndef __CH32F20X_USBOTG_HOST_H__
#define __CH32F20X_USBOTG_HOST_H__
#include "debug.h"
#include "string.h"
...
extern __attribute__ ((aligned(16))) UINT8 endpRXbuff[]; //端点1数据收发缓冲区
extern __attribute__ ((aligned(16))) UINT8 endpTXbuff[]; //端点3数据收发缓冲区
/*******************函数外扩*******************/
